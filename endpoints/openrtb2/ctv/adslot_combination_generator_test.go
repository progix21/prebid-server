...
// func TestAdSlotCombinationWithoutRepeatations(t *testing.T) {
// 	// set each scenario such that repeatation will NOT be allowed
// 	allowRepeatation := false
...
func coreTest(t *testing.T, allowRepeatation bool) {
	for _, test := range testBidResponseMaxDurations {
		...
		// if test.scenario != "TC9-max_ads = input_bid_durations = 4" {
		// 	continue
		// }
